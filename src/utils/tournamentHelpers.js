// This file contains shared utility functions for tournament logic and display.
...
export const getTN = (id, tournament) => {
...
export const getTC = (id, tournament) => {
  const t = tournament?.teams.find(team => team.id === id);
  return t ? t.color : COLORS.primary;
};

export const getStats = (tournament) => {
...
export const getPlayerStats = (tournament) => {
